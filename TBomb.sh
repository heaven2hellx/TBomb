...
╚═══╩═══╩═══╝╚═╝╚═╩═══╝
    ...
    echo -e "\e[1;32m           Telegram: https://t.me/bi0xx_network \e[0m"
    echo -e "\e[4;32m   Ｇø∂ ✘ø : 🕊️⃝💙✰ ⃟ ⃟ Ｇø∂⚡️❥⃝ ✘🕊️⃝ø✰🇮🇳⃝❤️ \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of 🕊️⃝💙✰ ⃟ ⃟ Ｇø∂⚡️❥⃝ ✘🕊️⃝ø✰🇮🇳⃝❤️ for more stability."
    echo " "
}
